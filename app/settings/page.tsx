                      ...
                      <div className="grid grid-cols-3 gap-4">
                        <div 
                          className={`border rounded-md p-4 cursor-pointer flex flex-col items-center ${
                            settings.appearance.theme === "light" ? "border-green-500 bg-green-50" : "border-gray-200"
                          }`}
                        ...
                        <div 
                          className={`border rounded-md p-4 cursor-pointer flex flex-col items-center ${
                            settings.appearance.theme === "dark" ? "border-green-500 bg-green-50" : "border-gray-200"
                          }`}
                        ...
                        <div 
                          className={`border rounded-md p-4 cursor-pointer flex flex-col items-center ${
                            settings.appearance.theme === "system" ? "border-green-500 bg-green-50" : "border-gray-200"
                          }`}
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch 
                        ...
                        onCheckedChange={(checked) => updateSettings("privacy", "shareActivity", checked)}
                      />
                    </div>
                  </div>
                </CardContent>
