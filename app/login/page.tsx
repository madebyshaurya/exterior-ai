...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      // Note: The page will redirect to Google at this point
      // When the user returns, the auth context's getRedirectResult handler will process the result
      // and update the user state, which will trigger the useEffect to redirect to dashboard

      setIsSuccess(true);
      console.log("Google login initiated successfully");

      // We don't need to set isLoading to false here because the page will redirect
    } catch (error) {
